...
class ChunkingStrategyComparator:
    ...
    def compare(self, text: str, chunk_size: int = 200) -> dict:
        ...
        return {
            "fixed_size": stats(FixedSizeChunker(chunk_size=chunk_size).chunk(text)),
            "by_sentences": stats(SentenceChunker().chunk(text)),
            "recursive": stats(RecursiveChunker(chunk_size=chunk_size).chunk(text)),
        }
