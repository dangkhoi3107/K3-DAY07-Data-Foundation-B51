...
class EmbeddingStore:
    ...
    def __init__(
        ...
        try:
            ...
            # Backend đã chọn cho lab này: in-memory (xem lý do trong REPORT_CANHAN).
            # Không bật nhánh Chroma để tránh bug "_use_chroma=True nhưng chưa có client/collection".
            self._use_chroma = False
        except Exception:
            self._use_chroma = False
            self._collection = None
